...
describe("getConfigElement", () => {
  ...
  it("should handle missing configuration elements category", () => {
    ...
    expect(result).toThrow(
      new InvalidConfigElementError(
        `Could not find configuration element ${configName}. InvalidConfigElementError: Could not find configuration element ${configName}. Configuration element category not found`
      )
    );
  });
  ...
  it("should handle missing configuration element", () => {
    ...
    expect(result).toThrow(
      new InvalidConfigElementError(`Could not find configuration element ${configName}. InvalidConfigElementError: Could not find configuration element ${configName}. ${error}`)
    );
  });
...
describe("getConfElementAttributes", () => {
  ...
  beforeEach(() => {
    func = new ConfigElement();
    elementSpy = jasmine.createSpyObj("ConfigurationElement", ["getAttributeWithKey"]);
  });
  ...
  it("should return undefined if getAttributeWithKey throws an error", () => {
    ...
    expect(() => func.getConfElementAttributes(elementSpy)).toThrow(new Error(`Could not getAttributeWithKey() from element '${elementName}'. Error: getAttributeWithKey error`));
  });
